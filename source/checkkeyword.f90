...
!
  implicit none
  integer, parameter :: numkey=404        ! number of keywords
  integer            :: i                 ! counter
  integer            :: j                 ! counter
...
!
 ...
 &  'preeqcomplex', 'preeqmode', 'preeqspin', 'preeqsurface', 'preequilibrium', 'production', 'projectile', 'pruitt', & 
