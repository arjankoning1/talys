...
set bmargin 5
set title "^{/=14 99}Y(n,{/=22{/Symbol g}})^{/=14 100}Y" font ",25"
#
set pointsize 1.2
...
plot [1.e-8:1.][0.1:10000000.0] \
"/Users/koning/talys/samples/n-Y099-RRR/org/xs000000.tot" u ( $1 > 0. ? $1 : 1.e-10 ):( $2 > 0. ? $2 : 1.e-10 ) t "T=293.15 K" w lines linestyle 10, \
